    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 md:p-12 border border-gray-100 dark:border-gray-700">
        ...
        <div className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
          ...
          <p className="mb-4">
            We collect minimal information to provide our news curation and analysis service:
          </p>
          ...
          <ul className="list-disc pl-5 mb-4 space-y-2">
            <li>Provide and improve our AI curation models and user experience.</li>
          ...
          <p className="mb-4">
            If you have questions about this policy, please contact us at homepage contact us form.
          </p>
        </div>
      </div>
    </div>
